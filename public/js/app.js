//starts specialists
function appendSpecialistDivColumns() {
    const specialists = [
        {
    ...
    makeUsDiv.innerHTML = `
        ${specialists.map((x) => `
            <div class="col-lg-3 col-sm-12 col-md-6">
                <img src="${x.avatar}" class="rounded-circle d-block img-fluid py-3 mx-auto">
                <h5 class="iet__specialist__title text-uppercase py-3 text-md-center text-center text-lg-start">${x.specialist}</h5>
                <h5 class="iet__specialist__subtitle py-3 text-md-center text-center text-lg-start">
                    ${x.tag}
                </h5>
                <p class="iet__subtitle text-md-center text-center text-lg-start">
                    ${x.description}
                </p>
            </div>  
        `
...
//ends hard work foundation features

//Experience features
function appendExperienceFeaturesDivColumns() {
    const features = [
        {
    ...
    const featuresRow = document.getElementById("features__row");
    const featuresDiv = document.createElement("div");
    featuresDiv.classList.add("row");
    ...
    `;
    featuresRow.append(featuresDiv);
}
//end features
...
function init() {
    appendSpecialistDivColumns();
    appendFoundationDivColumns();
    appendExperienceFeaturesDivColumns();
